...
class Alpha(AlphaBase):
    ...
    def generate(self, di):
        ...
        std_vol1 = cuiyfOp.std(self.volume[di - self.delay - 63 + 1:di - self.delay + 1, valid_idx])
        std_vol2 = cuiyfOp.std(self.volume[di - self.delay - 63 - 3 + 1:di - self.delay - 63 + 1, valid_idx])
        ...
        alpha = cuiyfOp.rank(skew_vol)/(std_vol1 + 1)
