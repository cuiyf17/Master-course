...
class Alpha(AlphaBase):
    def __init__(self, cfg):
        ...
        self.KK = None
        self.num_instruments = len(uv.Instruments)
    ...
    def generate(self, di):
        ...
        group1 = OP.group_split2(g_returns, 40)
        group2 = OP.group_split2(g_close, 10)

        prices = self.close[start_di:end_di, valid_idx] / self.close[start_di-21:end_di-21, valid_idx] - 1
        prices1 = self.close[start_di-1:end_di-1, valid_idx] / self.close[start_di-22:end_di-22, valid_idx] - 1
        price0 = prices[1]
